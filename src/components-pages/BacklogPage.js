...
const BacklogPage = () => {
    ...
    const sprints = {
        ...
        'Sprint 2': [
            ...
            { taskName: 'Selecting the project topic', story: 'No', sprintReady: 'Yes', priority: 'High', status: 'Complete', storyPoints: 8, assignedToSprint: 'Yes' },
            { taskName: 'Allocating team members', story: 'No', sprintReady: 'Yes', priority: 'High', status: 'Complete', storyPoints: 8, assignedToSprint: 'Yes' },
            { taskName: 'Creating Website', story: 'No', sprintReady: 'Yes', priority: 'High', status: 'Complete', storyPoints: 32, assignedToSprint: 'Yes',general:true },
            { taskName: 'Designing the website', story: 'No', sprintReady: 'Yes', priority: 'High', status: 'Complete', storyPoints: 16, assignedToSprint: 'Yes' },
        ...
        'Sprint 3': [
            ...
            { taskName: 'Literature review about the similar projects', story: 'No', sprintReady: 'Yes', priority: 'Medium', status: 'Complete', storyPoints: 8, assignedToSprint: 'Yes' },
            { taskName: 'Evaluating platform and device requirements', story: 'No', sprintReady: 'Yes', priority: 'Medium', status: 'Complete', storyPoints: 8, assignedToSprint: 'Yes' },
            { taskName: 'Finding the most suitable technology options', story: 'No', sprintReady: 'Yes', priority: 'Medium', status: 'Complete', storyPoints: 8, assignedToSprint: 'Yes' },
            { taskName: 'User Experience', story: 'Yes', sprintReady: 'Yes', priority: 'Medium', status: 'In Progress', storyPoints: 64, assignedToSprint: 'No' ,general:true},
            { taskName: 'Determining the user flow', story: 'Yes', sprintReady: 'Yes', priority: 'Medium', status: 'Complete', storyPoints: 16, assignedToSprint: 'Yes' },
            { taskName: 'Sketching user interactions', story: 'Yes', sprintReady: 'Yes', priority: 'Medium', status: 'Complete', storyPoints: 16, assignedToSprint: 'Yes' },
            { taskName: 'Creating the user interface', story: 'Yes', sprintReady: 'Yes', priority: 'High', status: 'In Progress', storyPoints: 32, assignedToSprint: 'No' },
